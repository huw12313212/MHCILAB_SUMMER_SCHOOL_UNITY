...
struct  ThreadSafeDictionary_2_t648  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t647 * ____valueFactory_1;
	...
	Dictionary_2_t2135 * ____dictionary_2;
};
