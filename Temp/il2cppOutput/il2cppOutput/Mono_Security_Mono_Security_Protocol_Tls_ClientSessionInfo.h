...
struct  ClientSessionInfo_t777  : public Object_t
{
	...
	ByteU5BU5D_t408* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t408* ___masterSecret_5;
};
struct ClientSessionInfo_t777_StaticFields{
